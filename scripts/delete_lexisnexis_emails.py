"""
Script to delete all inbox emails from lexisnexis.co.uk

This script connects to Outlook via COM and permanently deletes
all emails from the lexisnexis.co.uk domain in the Inbox folder.
"""

import win32com.client


def delete_lexisnexis_emails():
    """Delete all inbox emails from lexisnexis.co.uk domain."""
    ...
    for item in inbox.Items:
        try:
            ...
            # Check if from lexisnexis.co.uk domain
            if sender_email.lower().endswith("@lexisnexis.co.uk"):
    ...
    print(f"\nFound {len(emails_to_delete)} emails from lexisnexis.co.uk")
    ...
    if empty_trash.lower() == "yes":
        ...
        for item in list(deleted_folder.Items):
            try:
                ...
                if sender.lower().endswith("@lexisnexis.co.uk"):
